...
EXEC aspnet_Roles_CreateRole 'PX', 'admin'

DECLARE @utcdate DateTime = getutcdate()
DECLARE @userId UniqueIdentifier

EXEC aspnet_membership_createuser 'PX', 'admin', 'Password!', '', 'name@company.com', '', '', 1, @utcdate, @utcdate, 1, 0, @userId OUT

EXEC aspnet_UsersInRoles_AddUsersToRoles 'PX', 'admin', 'admin', @utcdate
