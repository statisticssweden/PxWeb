Namespace PCAxis.Paxiom.Operations
    ...
    ''' <summary>
    ''' Class for handling ChangeText Operation
    ''' </summary>
    ''' <remarks></remarks>
    Public Class ChangeText
        ...
        Public Function Execute(lhs As PXModel, rhs As Object) As PXModel Implements IPXOperation.Execute
            If Not TypeOf rhs Is ChangeTextDescription Then
                Throw New PXOperationException("Parameter is not supported")
            End If

            Return Execute(lhs, CType(rhs, ChangeTextDescription))
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Function Execute(oldModel As PXModel, rhs As ChangeTextDescription) As PXModel
            ...
            'Variables
            For Each itm As KeyValuePair(Of String, String) In rhs.Variables
