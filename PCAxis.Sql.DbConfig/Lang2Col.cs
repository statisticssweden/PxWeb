...
namespace PCAxis.Sql.DbConfig
{
    ...
    /// <summary>
    /// Util Class for writing sqlcommands. For the columns which is lang2.
    /// </summary>
    public class Lang2Col
    {
        ...
        public Lang2Col(string colName, string tableAliasBase, Dictionary<string, string> metaSuffixByLanguage)
        {
        ...
        /// <returns></returns>
        public string ForSelectWithFallback(string langCode, Col col)
        {
