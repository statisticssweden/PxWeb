...
#End Region
    ...
    Private Sub ViewTable()
        ...
        If (IsEliminationSelectionsDone()) Then
            ...
            If Settings.Metadata.RemoveSingleContent = True AndAlso PaxiomManager.PaxiomModel.Meta.ContentVariable IsNot Nothing AndAlso sels.FirstOrDefault(Function(x) x.VariableCode.Equals(PaxiomManager.PaxiomModel.Meta.ContentVariable.Code)).ValueCodes.Count = 1 Then
