...
<div class="breadcrumb_container">
    <!-- <asp:ImageButton ID="HomeButton" runat="server" CssClass="breadcrumb_homebutton"/>-->
    ...
    <asp:HyperLink ID="lnkDb" runat="server" CssClass="breadcrumb_text breadcrumb_dblink"></asp:HyperLink>
    <asp:Label ID="lblSep2" runat="server" Text=">>" CssClass="breadcrumb_sep" Visible="false"></asp:Label>
    <asp:HyperLink ID="lnkPath1" runat="server" CssClass="breadcrumb_text breadcrumb_pathlink" Visible="false"></asp:HyperLink>
    <asp:Label ID="lblSep3" runat="server" Text=">>" CssClass="breadcrumb_sep" Visible="false"></asp:Label>
    <asp:HyperLink ID="lnkPath2" runat="server" CssClass="breadcrumb_text breadcrumb_pathlink" Visible="false"></asp:HyperLink>
    <asp:Label ID="lblSep4" runat="server" Text=">>" CssClass="breadcrumb_sep" Visible="false"></asp:Label>
    <asp:HyperLink ID="lnkPath3" runat="server" CssClass="breadcrumb_text breadcrumb_pathlink" Visible="false"></asp:HyperLink>
    <asp:Label ID="lblSep5" runat="server" Text=">>" CssClass="breadcrumb_sep" Visible="false"></asp:Label>
    <asp:HyperLink ID="lnkPath4" runat="server" CssClass="breadcrumb_text breadcrumb_pathlink" Visible="false"></asp:HyperLink>
    <asp:Label ID="lblSep6" runat="server" Text=">>" CssClass="breadcrumb_sep" Visible="false"></asp:Label>
    <asp:HyperLink ID="lnkPath5" runat="server" CssClass="breadcrumb_text breadcrumb_pathlink" Visible="false"></asp:HyperLink>
